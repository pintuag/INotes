...
import com.inotes.Adapters.SubjectsNotesAdapter;
...
public class SubjectsNotes extends Fragment {
    ...
    private void getDataFromFirebase() {
        ...
        try {
            databaseReference = FirebaseDatabase.getInstance().getReference().child("Users").child("Teacher").child(course).child(semester);
    ...
    private void setAdapter() {
        ...
        try {
            adapter = new SubjectsNotesAdapter(getActivity(), list,semester, getActivity().getSupportFragmentManager());
